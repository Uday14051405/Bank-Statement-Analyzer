...
<?php echo e(__('anchor.create.title')); ?>
...
<form action="<?php echo e(route('anchor.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="row justify-content-between align-content-between" style="height: 100%;">
                <div class="col-md-6">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('users.index')); ?>"><?php echo e(__('anchor.index.title')); ?></a></li>
                        <li class="breadcrumb-item active-breadcrumb"><a href="<?php echo e(route('users.create')); ?>"><?php echo e(__('anchor.create.title')); ?></a></li>
                    </ul>
                </div>
                <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('gst')); ?>" required="required">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="roles[]" id="roles" class="select2" multiple="multiple">
                                ...
                                <option value="<?php echo e($role->name); ?>" <?php echo e($role->name == 'Anchor' ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\anchor\create.blade.php ENDPATH**/ ?>