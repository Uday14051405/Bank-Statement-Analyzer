...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <p>Dear <?php echo e($investor->name); ?>,</p>
            <p>We are thrilled to inform you that a new investment opportunity is now live on <a href="https://rumbble.co" target="_blank">rumbble.co</a>! As you are our valued investors, you can access this deal at <?php echo e($amountsDeal['formatted_deal_live_date'] ?? ''); ?> on your active dashboard.</p>
            ...
            <table class="table">
                ...
                <!-- <tr>
                    ...
                    <tr>
                        ...
                        <td>₹ <?php echo e($amountsDeal['repayment_amount'] ?? ''); ?> (excluding TDS)</td>
                    </tr>
...
<!--                     
                    ...
                    <tr>
                        ...
                        <td><?php echo e($amountsDeal['maturity_amount'] ?? ''); ?> </td>
                    </tr>
                    
                    <tr>
                        <th>Repayment Amount</th>
                        <td><?php echo e($amountsDeal['repayment_amount'] ?? ''); ?> </td>
                    </tr>
                    <tr>
                        <th>Repayment Date</th>
                        <td><?php echo e($amountsDeal['formatted_repayment_date'] ?? ''); ?> </td>
                    </tr> -->
...
<a href="<?php echo e(url('/admin/deal/view_deal/' . $deal->id)); ?>" style="padding: 0.75rem 0.6rem !important; font-size: 0.875rem; line-height: 1.5; border-radius: 0.2rem; color: #fff; background-color: #4e73df; border: 1px solid #4e73df; text-decoration: none;">View Deal Now</a>
...
<?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\emails\deal-live-notification.blade.php ENDPATH**/ ?>