...
unset($__errorArgs, $__bag); ?>" required="required" value="<?php echo e(old('deal_number')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" required="required" value="<?php echo e(old('invoice_number')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
            value="<?php echo e(old('deal_due_date_days')); ?>"
            min="1" 
            max="8" 
            step="1"
...
unset($__errorArgs, $__bag); ?>" readonly value="<?php echo e(old('deal_due_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('invoice_due_date')); ?>">
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('deal_buffer_days')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('deal_live_date', date('Y-m-d'))); ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <!-- <select name="deal_period" id="deal_period" class="select2">
                            ...
                            <option value="<?php echo e($role->value); ?>"><?php echo e($role->value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select> -->
...
unset($__errorArgs, $__bag); ?>" required="required" value="<?php echo e(old('deal_period')); ?>" min="30" max="180">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="maturity_amount" name="maturity_amount" class="form-control" readonly value="<?php echo e(old('maturity_amount')); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="repayment_amount" name="repayment_amount" class="form-control" readonly value="<?php echo e(old('repayment_amount')); ?>">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('upload_invoice')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\deal\create.blade.php ENDPATH**/ ?>