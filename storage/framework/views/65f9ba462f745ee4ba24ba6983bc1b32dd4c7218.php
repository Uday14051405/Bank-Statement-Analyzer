...
<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <!-- Frontend -->
        <!-- <li class="nav-item">
            <a href="" target="_blank" class="dropdown-toggle nav-link" title="Front End">
...
<!-- /Header --><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\resources\views\admin\layouts\header.blade.php ENDPATH**/ ?>