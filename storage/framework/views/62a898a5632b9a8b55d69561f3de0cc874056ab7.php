...
<div class="card breadcrumb-card">
    <div class="row justify-content-between align-content-between" style="height: 100%;">
        <div class="col-md-6">
            <h3 class="page-title"><?php echo e(__('reports.mis.title')); ?></h3>
            <ul class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                </li>
                <li class="breadcrumb-item active-breadcrumb">
                    <a href="<?php echo e(route('deal.index')); ?>"><?php echo e(__('reports.mis.title')); ?></a>
                </li>
            </ul>
        </div>
        <div class="col-md-6 text-right">
            <a href="<?php echo e(route('reports.export_payments')); ?>" class="btn btn-primary mt-2">Export MIS</a>
        </div>
    </div><!-- /card finish -->
</div><!-- /Page Header -->
    ...
    <script>
        $(function() {
            $('#table').DataTable({
                ...
                ajax: '<?php echo e(route('reports.mis')); ?>',
                columns: [
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\resources\views\admin\reports\mis.blade.php ENDPATH**/ ?>