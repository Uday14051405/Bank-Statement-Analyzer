...
<head>
    ...
    <script>
        var angularUrl = '<?php echo e(asset('laravel-log-reader/angular.min.js')); ?>';
...
<header>
    ...
    <div class="actions">
        ...
        <a class="btn" href="<?php echo e(url(config('laravel-log-reader.admin_panel_path'))); ?>">Goto Admin Panel</a>
        ...
        myApp.controller("LogCtrl", function ($scope, $http) {
            ...
            $scope.init = function (date) {
                ...
                if (date !== '' && date !== undefined) {
                    url = '<?php echo e(url(config('laravel-log-reader.api_route_path'))); ?>?date=' + date
                } else {
                    url = '<?php echo e(url(config('laravel-log-reader.api_route_path'))); ?>'
                }
            ...
            $scope.clearAll = function () {
                if (confirm("Are you sure?")) {
                    var url = '<?php echo e(url(config('laravel-log-reader.view_route_path'))); ?>'
...
</html><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\vendor\haruncpi\laravel-log-reader\views\index.blade.php ENDPATH**/ ?>