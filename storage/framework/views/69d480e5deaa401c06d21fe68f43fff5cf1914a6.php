					...
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active-breadcrumb">
								<a href="<?php echo e(route('users.edit', $user->id)); ?>"><?php echo e(__('user.edit.title')); ?> - (<?php echo e($user->name); ?>)</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3">
						...
						<div class="col-md-4 col-sm-12" style="margin: auto;">
							<div class="input-group mb-5">
								<?php if(!empty($user->image)): ?>
									<img src="<?php echo e($user->image); ?>" alt="..." id="output" class="img-thumbnail rounded mx-auto d-block mb-3"  onerror="this.src='<?php echo e(asset('assets/admin/img/default-user.png')); ?>';">
								<?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\resources\views\admin\customer\edit.blade.php ENDPATH**/ ?>