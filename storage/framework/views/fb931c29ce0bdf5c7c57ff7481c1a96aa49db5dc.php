<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('user.index.title')); ?>
  ...
  $(document).on('click', '.view-user-btn', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#userCreatedAt').text(data.created_at);
                        $('#userUpdatedAt').text(data.updated_at);
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\users\index.blade.php ENDPATH**/ ?>