...
<body>
    ...
    <p>
        <strong><?php echo e($other_data['financier_name'] ?? ''); ?></strong>, having PAN <strong><?php echo e($other_data['panNumber'] ?? ''); ?></strong> (hereinafter referred to as “Financier”, which expression shall, unless repugnant to the context or meaning thereof, be deemed to mean and include its successors and permitted assigns) of the Third Part.
    </p>
    <p>
    ...
    <div class="clause">
        ...
        <div class="indent">
            ...
            <p class="indent"><b>Email: </b><?php echo e($other_data['email'] ?? ''); ?></p>
            <br>
            ...
            <p class="indent"><b>Name: </b><?php echo e($companyDetail->name ?? ''); ?></p>
            <p class="indent"><b>Designation: </b><?php echo e($companyDetail->designation ?? ''); ?></p>
            <p class="indent"><b>Address: </b><?php echo e($companyDetail->address ?? ''); ?></p>
            <p class="indent"><b>Email: </b><?php echo e($companyDetail->email ?? ''); ?></p>
        </div>
    ...
    <div class="clause">
        ...
        <p><strong>Account number - <?php echo e($companyDetail->account_number ?? ''); ?></strong></p>
        <p><strong>IFSC Code - <?php echo e($companyDetail->ifsc_code ?? ''); ?></strong></p>
        <p><strong>Bank Name - <?php echo e($companyDetail->bank_name ?? ''); ?></strong></p>
        <p><strong>Branch - <?php echo e($companyDetail->branch ?? ''); ?></strong></p>
    </div>
    <br>
    ...
    <div class="button-container">
        ...
        <form action="<?php echo e(route('invest.download-pdf', ['id' => $deal_id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="vendor_name" value="<?php echo e($other_data['vendor_name'] ?? ''); ?>">
            <input type="hidden" name="vendor_address" value="<?php echo e($other_data['vendor_address'] ?? ''); ?>">
            <input type="hidden" name="financier_name" value="<?php echo e($other_data['financier_name'] ?? ''); ?>">
            <input type="hidden" name="financier_address" value="<?php echo e($other_data['financier_address'] ?? ''); ?>">
...
</html><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\agreement\agreement1.blade.php ENDPATH**/ ?>