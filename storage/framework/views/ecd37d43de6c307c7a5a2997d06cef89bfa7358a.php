...
<div class="fullHeightContainer">
    ...
    <div class="userAuthBody">
        ...
        <div class="userAuthBox">
            <div class="authCard">
                <form class="panForm" method="POST" action="<?php echo e(route('form-bank-details.post')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.app-backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\resources\views\frontend\userbank.blade.php ENDPATH**/ ?>