<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('currency.create.title')); ?>
...
<?php $__env->startSection('content'); ?>
	<form method="post" action="<?php echo e(route('currencies.store')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
					...
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active-breadcrumb">
								<a href="<?php echo e(route('currencies.create')); ?>"><?php echo e(__('currency.create.title')); ?></a>
							</li>
						</ul>
					</div>
					<div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>" required="required" value="<?php echo e(old('code')); ?>">
...
unset($__errorArgs, $__bag); ?>" required="required" value="<?php echo e(old('symbol')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\resources\views\admin\currencies\create.blade.php ENDPATH**/ ?>