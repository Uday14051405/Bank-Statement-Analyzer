<script>
    ...
    myApp.controller("LogCtrl", function ($scope, $http) {
        ...
        var ROUTE_PATH = '<?php echo e(url(config('user-activity.route_path'))); ?>';
        $scope.selected = {};
        $scope.popup = false;
...
</script><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\vendor\haruncpi\laravel-user-activity\views\partials\script.blade.php ENDPATH**/ ?>