                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <!-- Form -->
                            <form action="<?php echo e(route('forget.password.post')); ?>" method="POST"  autocomplete="off">
                            <?php echo csrf_field(); ?>
                            ...
                            <br>
                                ...
                                <a href="<?php echo e(url('/home')); ?>" class="btn btn-secondary btn-block">Go to Home</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\forgotPassword.blade.php ENDPATH**/ ?>