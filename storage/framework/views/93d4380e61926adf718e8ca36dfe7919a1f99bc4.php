...
<table width="100%" style="min-height: 400px; padding: 50px; margin: 0; background: linear-gradient(180deg, #1b5a90, #006266); color: #fff">
  ...
  <tr>
    <td style="width: 100%; text-align: center;">
		...
		<p>You can reset password from bellow link: <a href="<?php echo e(route('reset.password.get', $token)); ?>">Reset Password</a></p>
    </td>
  </tr> 

</table><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\auth\resources\views\emails\forgotPassword.blade.php ENDPATH**/ ?>