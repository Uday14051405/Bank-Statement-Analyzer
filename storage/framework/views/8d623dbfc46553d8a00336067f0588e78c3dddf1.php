...
<header>
    ...
    <div class="actions">
        <a class="btn" href="<?php echo e(url(config('user-activity.admin_panel_path'))); ?>">Goto Admin Panel</a>
...
<section class="content">
        ...
        <div class="top_content_right">
            ...
            <div class="filter_item">
                ...
                <select ng-model="filter.log_type">
                    <?php $__currentLoopData = ['create','edit','delete','login','lockout']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <footer>
        ...
        <div class="footer_right">
          <span class="text_light">Delete data older than <?php echo e(config('user-activity.delete_limit')); ?> days</span>
    ...
    <?php echo $__env->make('LaravelUserActivity::partials.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</section>

</body>
</html><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\vendor\haruncpi\laravel-user-activity\views\index.blade.php ENDPATH**/ ?>