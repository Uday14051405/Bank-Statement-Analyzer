            ...
            <div class="row justify-content-between align-content-between" style="height: 100%;">
                <div class="col-md-6">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('users.index')); ?>"><?php echo e(__('user.index.title')); ?></a></li>
                        <li class="breadcrumb-item active-breadcrumb"><a href="<?php echo e(route('users.create')); ?>"><?php echo e(__('user.create.title')); ?></a></li>
                    </ul>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="roles[]" id="roles" class="select2" multiple="multiple">
                                ...
                                <?php if(!in_array($role->name, ['Super Admin', 'Investor', 'Customer', 'Anchor'])): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\users\create.blade.php ENDPATH**/ ?>