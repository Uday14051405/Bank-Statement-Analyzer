...
<div class="container d-flex justify-content-center align-items-center my-5">
    <div class="contact-box row">
        ...
        <div class="contact-form-wrapper col-lg-8 col-md-7">
            <form class="form py-3" method="POST" id="contact-form" action="<?php echo e(route('contact-us-store')); ?>">
            <?php echo csrf_field(); ?>
                <div class="row g-3">
                    <div class="col-md-6">
...
</script><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\frontend\contact.blade.php ENDPATH**/ ?>