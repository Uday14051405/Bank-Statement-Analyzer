        ...
        <div class="profile">
            ...
            <div class="dropdown14">
                ...
                <div class="dropdown-content14">
                    <!-- <a href="<?php echo e(route('customer_profile')); ?>">Profile</a> -->
                    <a href="<?php echo e(route('customer_logout')); ?>">Log out</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="dynamic">
    ...
    </div><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\frontend\header-backend.blade.php ENDPATH**/ ?>