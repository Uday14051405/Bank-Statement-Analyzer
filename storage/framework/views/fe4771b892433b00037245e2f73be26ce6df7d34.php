<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('investor.index.title')); ?>
                ...
                <div class="col-md-6">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active-breadcrumb">
                            <a href="<?php echo e(route('users.index')); ?>"><?php echo e(__('investor.index.title')); ?></a>
                        </li>
                    </ul>
                </div>
                    ...
                    <table class="table table-hover table-center mb-0" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class=""><?php echo e(__('default.table.pan_number')); ?></th>
                                <th class=""><?php echo e(__('default.table.status')); ?></th>
                                <?php if(Gate::check('investor-edit') || Gate::check('investor-delete')): ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        $(function() {
            $('#table').DataTable({
                ...
                serverSide: true,
                order: [[0, 'desc']],
                ajax: '<?php echo e(route('investor.index')); ?>',
                columns: [
            ...
            $(document).on('click', '.view-user-btn', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("investor.show", ":id")); ?>'.replace(':id', userId),
                    type: 'GET',
    ...
    bankRow += 'N/A'; // Display 'N/A' or another placeholder if no link is available
        ...
        document.getElementById('export-button').addEventListener('click', function() {
            ...
            var exportUrl = '<?php echo e(route("investor.export")); ?>' + '?deal_status=' + dealStatus + '&from_date=' + fromDate + '&to_date=' + toDate;
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\investor\index.blade.php ENDPATH**/ ?>