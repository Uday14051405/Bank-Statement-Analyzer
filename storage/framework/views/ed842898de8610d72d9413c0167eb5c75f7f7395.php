<?php $__env->startSection('page_title'); ?>
    <?php echo e(__('investor.edit.title')); ?>
...
<?php $__env->startSection('content'); ?>
	<form method="post" action="<?php echo e(route('investor.update', $user->id)); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
		...
		<div class="page-header">
			<div class="card breadcrumb-card">
				<div class="row justify-content-between align-content-between" style="height: 100%;">
					<div class="col-md-6">
						<h3 class="page-title"><?php echo e(__('investor.index.title')); ?></h3>
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
							</li>
							<li class="breadcrumb-item">
								<a href="<?php echo e(route('investor.index')); ?>"><?php echo e(__('investor.index.title')); ?></a>
							</li>
							<li class="breadcrumb-item active-breadcrumb">
								<a href="<?php echo e(route('investor.edit', $user->id)); ?>"><?php echo e(__('investor.edit.title')); ?> - (<?php echo e($user->name); ?>)</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($user->pan_name); ?>" required="required">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card">
					...
					<div class="form-group">
                            <label for="bank_name" class="required"><?php echo e(__('default.form.account_holder_name')); ?>:</label>
                            <input type="text" name="account_holder_name" id="account_holder_name" class="form-control <?php $__errorArgs = ['account_holder_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-control-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required="required" value="<?php echo e($user->account_holder_name); ?>">
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group">
                        <label for="upload_invoice" class=""><?php echo e(__('default.form.cheque_passbook')); ?>:</label>
                        <input type="file" name="cheque_passbook" id="cheque_passbook" class="form-control <?php $__errorArgs = ['cheque_passbook'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-control-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  value="<?php echo e(old('cheque_passbook')); ?>">
                        <?php $__errorArgs = ['cheque_passbook'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
						...
						<?php if($user->cheque_pass): ?>
                                    <a href="<?php echo e(asset('storage/' . $user->cheque_pass)); ?>" target="_blank">View</a>
                                    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81New\htdocs\pws_bsa_25feb\bsa\resources\views\admin\investor\edit.blade.php ENDPATH**/ ?>