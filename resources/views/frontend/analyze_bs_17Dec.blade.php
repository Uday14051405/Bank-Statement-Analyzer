    ...
    <div class="content">
                    ...
                    <div class="step {{ $runAnalysisStatus ? 'disabled-div' : '' }}" style="width: 80%;" id="run_step1">
                        ...
                        <table class="upload-table">
                            <thead class="thead-hide">
                                <tr>
                                    <th class="hide-th-extra" style="border-bottom: 2px solid #ddd;" colspan="5">
                                        Bank Statement
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <thead class="thead-hide">
                                <tr>
                                    <th class="hide-th-extra">BANK_STATEMENT</th>
                                    <th class="hide-th-extra">
                                        <center>PDF</center>
                                    </th>
                                    <th class="hide-th-extra">
                                        <center>10mb</center>
                                    </th>
                                    <th class="action-cell-del" style="float: inline-end;"><label id="add-file-btn" class="upload-btn">
        ...
        <div class="loading-modal" id="loadingModal">
            <div class="modal-content">
                ...
                <h2>Analysis in progress, You can wait here or download output from the SMS notification.</h2>
            </div>
        </div>
...
<script>
    ...
    const addFileRow = (fileData) => {
        ...
        row.innerHTML = `
            <td data-label="Name" class="make-center" style="word-break: break-all;">BANK_STATEMENT</td>            
            <td data-label="File Name" class="make-center"><input type="text" class="hidden" hidden value="${file_name}" readonly>
            ...
            <td data-label="Max Size">${max_size}mb</td>
            
            <td data-label="Action" class="action-cell-del" style="float: inline-end;">
        ...
        nextRow.innerHTML = `
        <td data-label="Check" style="background-color: #eff0f3;" class="make-center make-small">
        ...
        <td data-label="Bank Name" style="background-color: #eff0f3;">
        <select>
            <option value="" selected hidden>Bank Name</option>
        ...
        <td data-label="Password Protected"  style="background-color: #eff0f3;">
        ...
        <td data-label="Password" style="background-color: #eff0f3;">
            <div style="position: relative; display: flex; align-items: center;">
                <input type="password" value="${file_pwd || ''}" ${password_protected === 'No' ? 'selected' : '' } style="padding-right: 30px;">
                <span class="toggle-password" style="position: absolute; right: 10px; cursor: pointer;">
                    <i class="fa-solid fa-eye toggle-password-symbol hidden" hidden></i>
                </span>
            </div>
        </td>

        <td data-label="Save" style="background-color: #eff0f3;">
            <button class="save-btn make-center" ${upload_status==='s3' ? '' : '' } style="background-color: #273896;">Save</button>
        </td>
        ...
        if (fileRows.childElementCount > 0) {
            ...
            downloadOutputButton.disabled = !runAnalysisStatus;
        } else {
        ...
        passwordSelect.addEventListener('change', () => {
            ...
            if (passwordSelect.value === 'Yes') {
                ...
                if (togglePasswordBtn) {
                    ...
                    togglePasswordSymbol.style.display = 'inline-block';
                }
            } else {
                ...
                if (togglePasswordBtn) {
                    ...
                    togglePasswordSymbol.style.display = 'none';
                }
            }
        });
        ...
        saveBtn.addEventListener('click', () => {
            ...
            const passwordProtected = nextRow.querySelector('.password-select').value;
            ...
            if (!passwordProtected) {
                alert("Please select Is file password procted or not.");
                return;
            }

            if (passwordProtected === "Yes") {
...
downloadOutputButton.addEventListener('click', async () => {
    try {
        ...
        if (data.success && data.file_url) {
            ...
            hideLoadingModal_msg('error', data.error || 'Failed to download the file.');
        }
    } catch (error) {
        console.error('Error:', error);
        hideLoadingModal_msg('error', 'An error occurred while downloading the file.');
    }
});
</script>
