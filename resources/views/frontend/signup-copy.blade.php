...
@endif
        ...
        <input type="hidden" id="event_id" name="event_id" value="">
            ...
            <div class="form-group checkbox-group">
                ...
                <label for="terms" style="font-size: 12px !important; color: black;">
                    I agree to the <a href="{{ route('terms') }}" style="font-size: 12px;" target="_blank">T&C</a>, <a href="{{ route('policy') }}" style="font-size: 12px;" target="_blank">Privacy policy</a> and authorise OneInfinity representatives to contact me and receive my credit information. This consent supersedes  any DNC registration by me.
                </label>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let otpSent = false;
            const maxAttempts = {{ env('SMS_ATTEMPT_BLOCK', 100) }}; 
            ...
            document.getElementById('otpForm').addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    if (result.status === 'success') {
                        ...
                        window.location.href = "{{ route('analyze_index') }}";
                    } else {
                        showErrorNotification( result.error, 'error');
                    }
                } catch (error) {
