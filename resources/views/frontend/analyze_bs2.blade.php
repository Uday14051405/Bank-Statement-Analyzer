...
<script>
    function initializeCustomDropdown(documentId) {
        ...
        selectedBank.addEventListener('click', () => {
            ...
            bankOptions.style.width = 'auto'; // Allow the width to expand based on content
        ...
        bankOptions.querySelectorAll('.dropdown-option').forEach(option => {
            option.addEventListener('click', function() {
                ...
                bankOptions.style.width = '100%'; // Set back to original width
                searchInput.style.width = '100%'; // Set back to original width
            });
        });
