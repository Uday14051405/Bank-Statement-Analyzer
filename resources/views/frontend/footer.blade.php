            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mb-3 mb-md-0">
                    <ul class="footer-menu-item list-unstyled text-center text-md-start">
                        <li class="scroll mb-2">
                            <a href="{{ url('terms') }}" class="text-white text-decoration-none">Terms & Conditions</a>
                        </li>
                        <li class="scroll mb-2">
                            <a href="{{ url('policy') }}" class="text-white text-decoration-none">Privacy Policy</a>
                        </li>
                        <li class="scroll">
                ...
                <div class="col-md-6 col-12 text-center text-md-end">
                    <p class="m-0" style="color:#ffff;">
                        &copy;{{ date('Y') }} Powered by Oneinfinity. All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
