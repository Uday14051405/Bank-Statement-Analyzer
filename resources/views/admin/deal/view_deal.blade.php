        ...
        <div class="row justify-content-between align-content-between" style="height: 100%;">
            <div class="col-md-6">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('deal.index') }}">Deals</a>
                    </li>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ __('default.table.currency_symbol') }} {{ $deal->maturityAmountDeal ?? '' }} </td>
                            </tr>
                            <tr>
                                <th>Invoice</th>
                                <td>
                    ...
                    <div class="col-md-6">
                        ...
                        <tr >
                            ...
                            <tr>
                                ...
                                <td>{{ __('default.table.currency_symbol') }} {{ $deal->repaymentAmountDeal ?? '' }} </td>
                            </tr>
                        </table>
                    </div>
                ...
                @if(Auth::user()->hasRole('Investor') && $deal->deal_status == 'Pending')
                <div class="row mt-4">
    <div class="col-md-12 text-center">
    <div class="terms">
                    <input type="checkbox" name="terms" id="terms" />
                    <label for="terms">I accept the <a href="{{ route('invest.generate-agreement', ['id' => $deal->id]) }}" target="_blank">terms and conditions</a></label>
                    @error('terms')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                @if($deal->bank_status == 'true')
        <button id="invest-button" class="btn btn-primary"  style="cursor: not-allowed" >Invest</button>
        <div id="loader" style="display:none;">Loading...</div>
        @else
        <p style="color:red;">{{ $deal->bankStatusMessage }}</p>
        @endif
    </div>
</div>
                @endif
       ...
       //loader.style.display = 'block';
        fetch('{{ route('invest.create-order') }}', {
                    ...
                    body: JSON.stringify({
                        ...
                        min_investment_amount: {{ $deal->invoice_value }},
                        _token: '{{ csrf_token() }}'
                    })
                })
