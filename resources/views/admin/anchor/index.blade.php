	...
	<div class="page-header">
		<div class="card breadcrumb-card">
			<div class="row justify-content-between align-content-between" style="height: 100%;">
				<div class="col-md-6">
					<h3 class="page-title">{{__('anchor.index.title')}}</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="{{ route('dashboard') }}">Dashboard</a>
						</li>
						<li class="breadcrumb-item active-breadcrumb">
							<a href="{{ route('users.index') }}">{{ __('anchor.index.title') }}</a>
						</li>
					</ul>
				</div>
                @if (Gate::check('anchor-create'))
                    <div class="col-md-6">
                        
                       
                <div class="create-btn pull-right">
                            <a href="{{ route('anchor.create') }}" class="btn custom-create-btn">{{ __('default.form.anchor-add-button') }}</a>
                        </div>     
...
<script>
    document.getElementById('export-button').addEventListener('click', function() {
        ...
        var exportUrl = '{{ route("anchor.export") }}' + '?deal_status=' + dealStatus + '&from_date=' + fromDate + '&to_date=' + toDate;
