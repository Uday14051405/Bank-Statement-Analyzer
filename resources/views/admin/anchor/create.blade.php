...
@section('content')
<form action="{{ route('anchor.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="row justify-content-between align-content-between" style="height: 100%;">
                <div class="col-md-6">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('users.index') }}">{{ __('anchor.index.title') }}</a></li>
                        <li class="breadcrumb-item active-breadcrumb"><a href="{{ route('users.create') }}">{{ __('anchor.create.title') }}</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="roles[]" id="roles" class="select2" multiple="multiple">
                                ...
                                <option value="{{ $role->name }}" {{ $role->name == 'Anchor' ? 'selected' : '' }}>
                                    {{ $role->name }}
                                </option>
                                @endforeach
                            </select>
