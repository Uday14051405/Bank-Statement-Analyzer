				...
				<div class="col-md-6">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active-breadcrumb">
							<a href="{{ route('users.index') }}">{{ __('customer.index.title') }}</a>
						</li>
					</ul>
				</div>
                @if (Gate::check('customer-create'))
                    <div class="col-md-6">
                        <div class="create-btn pull-right">
                            <a href="{{ route('customer.create') }}" class="btn custom-create-btn">{{ __('default.form.customer-add-button') }}</a>
                        </div>    
                    ...
                    <table class="table table-hover table-center mb-0" id="table">
                        <thead>
                            <tr>
                                ...
                                @if (Gate::check('customer-edit') || Gate::check('customer-delete'))
...
@push('scripts')
  ...
  $(document).on('click', '.view-user-btn1', function() {
                ...
                $.ajax({
                    url: '{{ route("customer.show", ":id") }}'.replace(':id', userId),
                    type: 'GET',
...
<script>
    document.getElementById('export-button').addEventListener('click', function() {
        ...
        var exportUrl = '{{ route("customer.export") }}' + '?deal_status=' + dealStatus + '&from_date=' + fromDate + '&to_date=' + toDate;
